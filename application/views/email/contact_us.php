...
<table cellspacing="0" cellpadding="0" border="0"  style="border:none;font-family:Arial, Helvetica, sans-serif; color:#5a5754; font-size:12px; margin-bottom:20px; padding:0; border-collapse:collapse">
    ...
    <tr>
    	<td style="line-height:15px; padding:0; margin:0;"  width="150">Company</td>
        <td style="line-height:15px; padding:0; margin:0;" ><?=$message['company'];?></td>
    </tr>
    <?php } ?>
    <tr>
    ...
    <tr>
    	<td style="line-height:15px; padding:0; margin:0;"  width="150">Message</td>
        <td style="line-height:15px; padding:0; margin:0;" ><?=$message['message'];?></td>
    </tr>
</table>